...
! function(t) {
    ...
    n(99), n(53), n(102), n(258), n(259), n(260), n(261), t.exports = n(262)
}, function(t, e, n) {
    "use strict";
    var r = n(5);
    ...
    function yt(t) {
        ...
        return null == S || null == R ? [] : y.IS_BROWSER_ENV && i ? c(R).filter(function(t) {
            return i.contains(t)
        }) : w === X ? c(S, R) : w === G ? s(c(S)).filter(l(R)) : w === V ? f(c(S)).filter(l(R)) : c(R)
    }
    var mt = /px/,
        It = function(t, e) {
        ...
        T = function(t, e) {
            ...
            if (E && !g)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var F = (O - _) / m, j = E.config.easing, X = h(j, F, f), G = 0, V = a.length; G < V; G++) {
                        var k = a[G],
                            U = y(s, k, E.config),
                            B = (y(s, k, g.config) - U) * X + U;
                        L[k] = B
                    }
            return (0, o.merge)(t, {
                position: O,
        ...
        function P(t, e) {
            if (!t.open) {
                ...
                var i = M(t),
                    ...
                    c = t.el.height(),
                    f = t.el[0];
                if (x(0, f), m.intro(0, f), r.redraw.up(), a || l.on("click" + v, t.outside), !e) {
        ...
        function F(t, e) {
            ...
            function c() {
                t.menu.height(""), s(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(D), t.links.removeClass(y), t.dropdowns.removeClass(E), t.dropdownToggle.removeClass(g), t.dropdownList.removeClass(_), t.overlay && t.overlay.children().length && (I.length ? t.menu.insertAfter(I) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
            }
        }
        return c
    })
    ...
    "events": {
        "e": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb40071fa63c85922a62789|761f3b21-cf6f-5641-4777-58bb7d01c0ab"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-3": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb40071fa63c85922a62789|f70ff7c1-45db-20b9-bfa2-81154d06c49a"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-5": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb40071fa63c85922a62789|743efdc0-21e2-2997-998b-be3965f8613c"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-7": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb40071fa63c85922a62789|c5775b65-6c0a-ff2d-94b3-8eadb482a0db"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-9": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb40071fa63c85922a62789|37d29402-8767-6202-cf1c-c9342efc42c2"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-11": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5eb40071fa63c85922a62789|cf10ba6e-791a-821b-5f88-21c6826cc28b"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".img-portfolio",
                            "selectorGuids": ["a711c98a-5f19-38fa-07cb-567a1078b649"]
                        },
                        "zValue": 26,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
