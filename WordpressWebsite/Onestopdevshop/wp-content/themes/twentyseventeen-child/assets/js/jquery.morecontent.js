;(function($) {
	...
	var defaults = {
		...
		tpl: {
			...
			btn: '<button class="mrc-btn btn small w-button" type="button"></button>',
	...
	meth.init = function(options) {
		...
		_.defaults.textClose = $(self).attr('data-buttonmore');
		_.defaults.textOpen = $(self).attr('data-buttonless');
