...
if ( !function_exists( 'happy_baby_vc_get_css' ) ) {
	add_filter( 'happy_baby_filter_get_css', 'happy_baby_vc_get_css', 10, 4 );
	function happy_baby_vc_get_css($css, $colors, $fonts, $scheme='') {
