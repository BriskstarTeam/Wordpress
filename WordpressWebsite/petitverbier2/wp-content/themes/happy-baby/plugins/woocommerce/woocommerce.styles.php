...
if ( !function_exists( 'happy_baby_woocommerce_get_css' ) ) {
	add_filter( 'happy_baby_filter_get_css', 'happy_baby_woocommerce_get_css', 10, 4 );
	function happy_baby_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.happy_baby_shop_mode_buttons a {
	color: {$colors['bd_color']};
}
.happy_baby_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
...
.post_item_single .entry-summary p.price,
.post_item_single .entry-summary p.price * {
