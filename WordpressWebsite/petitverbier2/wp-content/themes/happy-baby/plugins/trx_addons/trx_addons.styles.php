...
if (!function_exists('happy_baby_trx_addons_get_css')) {
	add_filter('happy_baby_filter_get_css', 'happy_baby_trx_addons_get_css', 10, 4);
	function happy_baby_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.slider_swiper.slider_controls_side .slider_controls_wrap > a:hover, .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['text_hover']};
...
.scheme_self.sc_team_default .sc_team_item_subtitle {
	color: {$colors['inverse_link']};
}

.scheme_self.sc_team_default .sc_team_item_title a {
	color: {$colors['inverse_link']};
}
.scheme_self.sc_team_default .sc_team_item_title a:hover {
	color: {$colors['text_hover']};
}
...
.scheme_self.sc_team_default .sc_team_item_socials .social_item .social_icon {
	color: {$colors['text_link2']};
	background-color: {$colors['inverse_link']};
}
.scheme_self.sc_team_default .sc_team_item_socials .social_item:hover .social_icon {
	color: {$colors['text_link2']};
	background-color: {$colors['inverse_link']};
}
...
.sc_services_light .sc_services_item_featured_left:hover .sc_services_item_icon,
.sc_services_light .sc_services_item_featured_right:hover .sc_services_item_icon,
...
.scheme_self.sc_services_timeline .sc_services_item_title a {
	color: {$colors['text_dark']};
}
.scheme_self.sc_services_timeline .sc_services_item_title a:hover {
	color: {$colors['text_link3']};
}
.scheme_self.sc_services_timeline .sc_services_item_content {
	color: {$colors['alter_text']};
}
...
.scheme_self.sc_services_default .sc_services_item_title a {
	color: {$colors['text_dark']};
}
.scheme_self.sc_services_default .sc_services_item_title a:hover {
	color: {$colors['text_link']};
}
...
.sc_blogger .top_cat .post_meta_item a {
	color: {$colors['text_link']};
}
.sc_blogger .top_cat .post_meta_item a:hover {
	color: {$colors['text_hover']};
}
