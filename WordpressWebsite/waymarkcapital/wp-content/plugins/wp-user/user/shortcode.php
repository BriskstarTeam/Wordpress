...
final class WPUserShortcode
{
   ...
   // include_once('includes/script.php');
    ...
    //echo "<pre>"; print_r($_SERVER['QUERY_STRING']); exit;
    ...
    if ((isset($atts['active']) && ($atts['active'] == 'register')) || ((isset($_SERVER['QUERY_STRING'])) && ($_SERVER['QUERY_STRING'] == 'action=register'))) {
        $register_class = 'active';
    } else if ((isset($atts['active']) && ($atts['active'] == 'forgot')) || ((isset($_SERVER['QUERY_STRING'])) && ($_SERVER['QUERY_STRING'] == 'action=forgot'))) {
        $forgot_class = 'active';
    } else {
        $login_class = 'active';
