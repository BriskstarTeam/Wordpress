...
if ( version_compare( $GLOBALS['wp_version'], '5.3', '<' ) ) {require get_template_directory() . '/inc/back-compat.php';
}
...
function enqueue_parent_styles()
{
  ...
  $child_style = 'twentyseventeen-child';
       ...
       if(is_page('home') || is_page('blog') || is_single() || is_archive() || is_page('about-us')){
         wp_enqueue_style( $child_style.'_home-style', get_theme_file_uri().'/assets/css/home-style.css' );  
       ...
       wp_enqueue_script($child_style.'_custom_script_js', get_template_directory_uri().'/assets/js/custom-scripts.js', ['jquery'], '', 'in_footer');
...
function wti_loginout_menu_link( $items, $args ) {
   if ($args->theme_location == 'primary') {
      ...
      if (!site_url() || is_user_logged_in()) {
         $items .= '<li class="right menu-item menu-item-type-post_type menu-item-object-page"><a href="'. wp_logout_url('user-login/?action=login') .'" class="menu-link">'. __("Logout") .'</a></li>';
      } else {
         $items .= '<li class="right menu-item menu-item-type-post_type menu-item-object-page"><a href="'. site_url() .'" class="menu-link">'. __("Log In") .'</a></li>';
      }
   }
   return $items;
}
