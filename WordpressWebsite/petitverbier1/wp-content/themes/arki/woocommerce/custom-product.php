 ...
 */
	...
	$sidebar_type = arki_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = arki_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = arki_get_option('general', 'woocommerce-archive-sidebar-right');		
