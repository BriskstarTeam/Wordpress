<?php
	...
	add_filter('revslider_getUsedFonts', 'arki_revslider_getUsedFonts');
	if( !function_exists('arki_revslider_getUsedFonts') ){
		function arki_revslider_getUsedFonts( $used_font ){
