 ...
 */
	...
	$settings = array(
		'query' => $wp_query,
		'product-style' => arki_get_option('general', 'woocommerce-archive-product-style', 'grid'),
		'thumbnail-size' => arki_get_option('general', 'woocommerce-archive-thumbnail', 'full'),
		'column-size' => arki_get_option('general', 'woocommerce-archive-column-size', '20'),
