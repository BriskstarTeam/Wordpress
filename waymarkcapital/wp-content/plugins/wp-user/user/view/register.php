...
?>
<div role="tabpanel" class="tab-pane <?php echo $register_class ?> register sailboat" id="registerController<?php echo $form_id ?>">
                    ...
                    <div class="col-xs-12">
                       ...
                       value="' . $atts['multi_steps'] . '">';
                        ...
                        if (get_option('wp_user_tern_and_condition')) { ?>
                            <h6 class="pass_protection">(password must be at least 8 characters with one lowercase letter,uppercase letter, special character, one number.)</h6>
                            <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <div class="col-xs-12">
                            ...
                            <ul class="term-conditions">
                                ...
                                <li>A natural person who has an individual net worth, or joint net worth with the person’s spouse, that exceeds $1 million at the time of the purchase, excluding the value of the primary residence of such person.</li>
                                <li>An entity that is a private business development company or an organization with assets exceeding $5 million.</li>
                            </ul>
